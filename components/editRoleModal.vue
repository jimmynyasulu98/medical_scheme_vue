...
<!-- Main modal -->
<div :id="edit-role-modal-`${role.id}`" tabindex="-1" aria-hidden="true" class="modal hidden overflow-y-auto overflow-x-hidden  z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full ">
    <div class="relative p-4  max-w-l max-h-full">
        ...
        <div class="relative bg-gray-400 rounded-lg shadow-sm dark:bg-white  text-black dark:text-black">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-red-500 hover:text-red-200 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-red-500 dark:hover:text-white" :data-modal-hide="edit-role-modal-`${role.id}`">
            ...
            <form class="p-4 md:p-5 space-y-4">
                ...
                <div class="w-full px-3">
                    ...
                    <input   class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-xs font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" id="service_provider" type="text" placeholder="Service Provider">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button :data-modal-hide="edit-role-modal-`${role.id}`" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium  focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:text-white dark:hover:bg-red-700">Close</button>
                </div>
            </form>
