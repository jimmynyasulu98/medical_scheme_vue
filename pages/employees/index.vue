<script setup>
    ...
    employeeStore.fetchEmployees(`employees`)
    ...
    <div class="flex-mx-3 mb-20 justify-center">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg ">
            <table class="w-full text-sm text-left rtl:text-right">
                ...
                <tbody> 
                    <tr class="hover:bg-gray-300 border-1 border-gray-100 "  v-for="(employee, index) in employeeStore.employees.data"  v-bind:key="index">
                        ...
                        <td class="px-2 py-1">
                            <NuxtLink :to="`employees/${employee.id}`" class="bg-blue-500 hover:bg-blue-600 focus:outline-none rounded-lg px-6 py-1
                                text-white font-semibold shadow hover:cursor-pointer" type="button"  >
                                Assign roles
                            </NuxtLink>
                        </td>
                    </tr>
